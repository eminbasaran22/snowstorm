        ...
        }); /* Part of Project: Ador Snow Simulation. (c): Ador Design (S. Bzdak / F. Bzdak) (all rights reserved). All Changes need approval. Usage is not allowed without permission by Ador Design. Publishing is not allowed without consent by Ador Design (S. Bzdak or F. Bzdak). */
        var k = null,
            m = null,
            n = null,
            p = null,
        ...
        function B(a) {
            var f = [];
            10 >= a ? (f.push("../images/snow/snowflake01_10px.png"), f.push("../images/snow/snowflake02_10px.png"), f.push("../images/snow/snowflake03_10px.png"), f.push("../images/snow/snowflake04_10px.png")) : 20 >= a ? (f.push("../images/snow/snowflake01_20px.png"), f.push("../images/snow/snowflake02_20px.png"), f.push("../images/snow/snowflake03_20px.png"), f.push("../images/snow/snowflake04_20px.png")) : 30 >= a ? (f.push("../images/snow/snowflake01_30px.png"), f.push("../images/snow/snowflake02_30px.png"), f.push("../images/snow/snowflake03_30px.png"), f.push("../images/snow/snowflake04_30px.png")) : (f.push("../images/snow/snowflake01_40px.png"), f.push("../images/snow/snowflake02_40px.png"), f.push("../images/snow/snowflake03_40px.png"), f.push("../images/snow/snowflake04_40px.png"));
            return f
        }
        ...
        function z() {
            ...
            a.qb = function(b) {.2 > b ? (a.O = 1, a.G = .2) : .4 > b ? (a.O = 2, a.G = .3) : .6 > b ? (a.O = 17, a.G = .4) : (a.O = .8 > b ? 30 : 60, a.G = .5);
                a.yb()
            };
            a.sb = function(b) {.05 > b ? (a.g = .001, a.h = 0) : .15 > b ? (a.g = 1, a.h = 10) : .25 > b ? (a.g = 3, a.h = 26) : .35 > b ? (a.g = 5, a.h = 36) : .45 > b ? (a.g = 7, a.h = 50) : .55 > b ? (a.g = 11, a.h = 77) : .65 > b ? (a.g = 14, a.h = 100) : .75 > b ? (a.g = 22, a.h = 170) : .85 > b ? (a.g = 40, a.h = 300) : .95 > b ? (a.g = 85, a.h = 550) : (a.g = 145, a.h = 1100);
                a.ob();
                a.xb()
            };
            a.pb = function(b) {
                a.aa = .05 > b ? 200 : .15 > b ? 300 : .25 > b ? 450 : .35 > b ? 600 : .45 > b ? 800 : .55 > b ? 1E3 : .65 > b ? 1400 : .75 > b ? 1800 : .85 > b ? 2500 : .95 > b ? 3200 : 3800;
                a.va = .5 * a.aa;
                a.wb();
                a.vb()
            };
            a.rc = function() {
                ...
                a.qa = [];
                if (0 >= a.pa && (a.pa = a.Na, a.a.length < a.Nb))
                    for (b = 0; b < a.Ra; b++) a.oc(b);
                a.pa -= a.X
            };
            a.ec = function(b) {
            ...
            a.dc = function() {
                for (var b = Math.random(), d = 0; d < a.u.length; d++)
                    if (b <= a.oa[d]) return d + a.l;
                return a.ua
            };
            a.Ac = function(b) {
                b -= a.l;
            ...
            a.tc = function() {
                a.S < a.v ? (a.f.globalAlpha = a.S, a.S += a.Ib) : (a.Ca ? (a.o += a.$, a.s -= a.$, 0 > a.s && (a.s = 0)) : (a.o -= a.$, 0 > a.o && (a.o = 0), a.s += a.$), a.o > a.v ? (a.o = a.v, a.Ca = !1, a.ha = Math.floor(Math.random() * a.Lb), .5 < Math.random() && (a.ha *= -1)) : 0 >= a.o && (a.Ca = !0), a.s > a.v && (a.s = a.v));
            ...
            a.ob = function() {
                for (var b = 0; b < a.N; b++) {
                    var d = Math.floor(Math.random() * a.h);.5 < Math.random() && (d *= -1);
                    a.gb.push(d)
                }
            };
            a.Ya = function() {
            ...
            a.fc = function(b, d) {
                ...
                null == c && 0 < window.pageXOffset && (e = a.b.style.left, e = e.substring(0, e.indexOf("px")), e = parseInt(e, 10) + window.pageXOffset, e = String(e) + "px", a.b.style.left = e, e = a.c.style.left, e = e.substring(0, e.indexOf("px")), e = parseInt(e, 10) + window.pageXOffset, e = String(e) + "px", a.c.style.left = e);
                null == c && 0 < window.pageYOffset && (c = a.b.style.top, c = c.substring(0, c.indexOf("px")), c = parseInt(c, 10) + window.pageYOffset, c = String(c) + "px", a.b.style.top = c, c = a.c.style.top, c = c.substring(0, c.indexOf("px")), c = parseInt(c, 10) + window.pageYOffset, c = String(c) + "px", a.c.style.top = c);
                0 < a.M && 1 >= a.M ? (.75 < a.M ? (a.I = 1.25 * a.b.width, a.Y = -.9, a.Z = 1.7) : .5 < a.M ? (a.I = 1.5 * a.b.width, a.Y = -1.7, a.Z = 2.5) : (a.I = 1.75 * a.b.width, a.Y = -2.5, a.Z = 3.3), a.fa = (a.I - a.b.width) / 2 * -1) : (a.I = a.b.width, a.fa = 0);
                a.j = new Image;
                a.j.src = "images/" + a.C + "snow_background.jpg";
                a.j.onload = function() {
                ...
                a.B = new Image;
                a.B.src = "images/" + a.C + "illumination_ray.png";
                a.Ya();
                a.hc();
                a.Ra = a.F / a.Sa;
                ...
                for (c = 0; c < a.N; c++) e = Math.floor(Math.random() * a.Tb), .5 < Math.random() && (e *= -1), a.hb.push(e);
                e = a.ua - a.l;
                g = a.ua - a.l;
                h = g - g * (1 - a.Sb);
                var l = a.l;
                ...
                for (c = 0; c <= e; c++) a.oa[c] = 0 == c ? .25 : a.oa[c - 1] + .25 * (1 - a.oa[c - 1]);
                for (c = 0; c <= e; c++)
                    for (g = c + a.l, a.K[g.toString()] = [], h = 0; h < a.Fa.length; h++) l = document.createElement("img"), l.src = 10 >= g ? a.C + a.Fa[h] : 20 >= g ? a.C + a.jb[h] : 30 >= g ? a.C + a.kb[h] : a.C + a.lb[h], l.id = "snow_" + h + "_" + g + "x" + g, l.alt = "snow", a.L.appendChild(l), a.K[g.toString()].push(l)
            };
            a.Xb = function() {
                clearInterval(a.Da);
        ...
        function C() {
            ...
            a.gc = function(f, b, d) {
                ...
                a.w = b;
                a.mb = d;
                a.ea = a.w.createLinearGradient(.8 * a.H.width, .15 * a.H.height, -.2 * a.H.width, .9 * a.H.height);
